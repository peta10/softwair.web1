        ...
        {plans.map((plan, index) => (
          <BackgroundGradient
            ...
            containerClassName={cn(
              "rounded-2xl h-full",
              plan.isPopular && isDesktop ? "lg:z-10" : "lg:mt-5"
            )}
            className="h-full"
          ...
          >
            <motion.div
              ...
              className={cn(
                `rounded-2xl border p-6 bg-[#22232A] text-center relative`,
                "border-[#32333A]",
              ...
              <div className="flex-1 flex flex-col">
                ...
                {plan.isPopular && (
                  <div className="mt-1 mb-3 flex justify-center">
                    <span className="bg-[#00FF79]/20 text-[#00FF79] py-1 px-3 rounded-full text-xs font-semibold inline-flex items-center gap-1">
                      <Star className="h-3 w-3 fill-current text-[#00FF79]" /> Popular
                    </span>
                  </div>
                )}
